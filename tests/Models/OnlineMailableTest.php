...
class OnlineMailableTest extends TestCase
{
    ...
    /** @test */
    function a_mailable_has_an_expiration_date()
    {
    ...
    /** @test */
    function a_mailable_expiration_date_can_be_null()
    {
        $mailable = OnlineMailable::factory()->create([
            'expires_at' => null,
        ]);
    ...
    /** @test */
    function an_online_mailable_has_the_expiration_date_as_specified_in_the_config()
    {
    ...
    /** @test */
    function an_online_mailable_can_have_an_indefinite_expiration_date()
    {
    ...
    /** @test */
    function an_online_mailable_can_get_its_signed_url()
    {
    ...
    /** @test */
    function an_online_mailable_without_expiration_can_get_its_signed_url()
    {
        /** @var OnlineMailable $mailable */
        $mailable = OnlineMailable::factory()->create([
            'expires_at' => null,
